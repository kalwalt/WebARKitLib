...
bool WebARKitTrackerSquare::initialize()
{
...
bool WebARKitTrackerSquare::isRunning()
{
...
// ----------------------------------------------------------------------------------------------------
void WebARKitTrackerSquare::setDebugMode(bool debug)
{
    m_debugMode = debug;
    if (m_arHandle0) {
...
bool WebARKitTrackerSquare::debugMode() const
{
    return m_debugMode;
}

void WebARKitTrackerSquare::setImageProcMode(int mode)
{
...
int WebARKitTrackerSquare::imageProcMode() const
{
    return m_imageProcMode;
}

void WebARKitTrackerSquare::setThreshold(int thresh)
{
...
int WebARKitTrackerSquare::threshold() const
{
    return m_threshold;
}

void WebARKitTrackerSquare::setThresholdMode(AR_LABELING_THRESH_MODE mode)
{
...
AR_LABELING_THRESH_MODE WebARKitTrackerSquare::thresholdMode() const
{
    return m_thresholdMode;
}

void WebARKitTrackerSquare::setLabelingMode(int mode)
{
    m_labelingMode = mode;
    if (m_arHandle0) {
...
int WebARKitTrackerSquare::labelingMode() const
{
    return m_labelingMode;
}

void WebARKitTrackerSquare::setPatternDetectionMode(int mode)
{
...
int WebARKitTrackerSquare::patternDetectionMode() const
{
    return m_patternDetectionMode;
}

void WebARKitTrackerSquare::setPattRatio(float ratio)
{
...
float WebARKitTrackerSquare::pattRatio() const
{
    return (float)m_pattRatio;
}

void WebARKitTrackerSquare::setMatrixCodeType(AR_MATRIX_CODE_TYPE type)
{
...
AR_MATRIX_CODE_TYPE WebARKitTrackerSquare::matrixCodeType() const
{
    return m_matrixCodeType;
}

void WebARKitTrackerSquare::setPatternSize(int patternSize)
{
...
int WebARKitTrackerSquare::patternSize() const
{
    return m_patternSize;
}

void WebARKitTrackerSquare::setPatternCountMax(int patternCountMax)
{
    if (!m_arPattHandle) return;
    if (m_arPattHandle->patt_num > 0) {
...
int WebARKitTrackerSquare::patternCountMax() const
{
    return m_patternCountMax;
}

bool WebARKitTrackerSquare::start(ARParamLT *paramLT, AR_PIXEL_FORMAT pixelFormat)
{
    return start(paramLT, pixelFormat, NULL, AR_PIXEL_FORMAT_INVALID, NULL);
}

bool WebARKitTrackerSquare::start(ARParamLT *paramLT0, AR_PIXEL_FORMAT pixelFormat0, ARParamLT *paramLT1, AR_PIXEL_FORMAT pixelFormat1, const ARdouble transL2R[3][4])
{
    ...
    ARLOGd("WebARKitTrackerSquare::start() done.\n");
    return true;
...
bool WebARKitTrackerSquare::update(AR2VideoBufferT *buff, std::vector<WebARKitTrackable *>& trackables)
{
    return update(buff, NULL, trackables);
}

bool WebARKitTrackerSquare::update(AR2VideoBufferT *buff0, AR2VideoBufferT *buff1, std::vector<WebARKitTrackable *>& trackables)
{
    ...
    ARLOGd("WebARKit::WebARKitTrackerSquare::update()\n");
    ...
    if (!buff1) {
        for (std::vector<WebARKitTrackable *>::iterator it = trackables.begin(); it != trackables.end(); ++it) {
            if ((*it)->type == WebARKitTrackable::SINGLE) {
                success &= ((WebARKitTrackableSquare *)(*it))->updateWithDetectedMarkers(markerInfo0, markerNum0, m_ar3DHandle);
            } else if ((*it)->type == WebARKitTrackable::MULTI) {
                success &= ((WebARKitTrackableMultiSquare *)(*it))->updateWithDetectedMarkers(markerInfo0, markerNum0, m_ar3DHandle);
            } else if ((*it)->type == WebARKitTrackable::MULTI_AUTO) {
                success &= ((WebARKitTrackableMultiSquareAuto *)(*it))->updateWithDetectedMarkers(markerInfo0, markerNum0, m_arHandle0->xsize, m_arHandle0->ysize, m_ar3DHandle);
            }
        }
    } else {
        for (std::vector<WebARKitTrackable *>::iterator it = trackables.begin(); it != trackables.end(); ++it) {
            if ((*it)->type == WebARKitTrackable::SINGLE) {
                success &= ((WebARKitTrackableSquare *)(*it))->updateWithDetectedMarkersStereo(markerInfo0, markerNum0, markerInfo1, markerNum1, m_ar3DStereoHandle, m_transL2R);
            } else if ((*it)->type == WebARKitTrackable::MULTI) {
                success &= ((WebARKitTrackableMultiSquare *)(*it))->updateWithDetectedMarkersStereo(markerInfo0, markerNum0, markerInfo1, markerNum1, m_ar3DStereoHandle, m_transL2R);
            } else if ((*it)->type == WebARKitTrackable::MULTI_AUTO) {
                success &= ((WebARKitTrackableMultiSquareAuto *)(*it))->updateWithDetectedMarkersStereo(markerInfo0, markerNum0, m_arHandle0->xsize, m_arHandle0->ysize, markerInfo1, markerNum1, m_arHandle1->xsize, m_arHandle1->ysize, m_ar3DStereoHandle, m_transL2R);
            }
        }
    }
...
void WebARKitTrackerSquare::terminate()
{
    if (m_arPattHandle) {
        arPattDeleteHandle(m_arPattHandle);
        m_arPattHandle = NULL;
...
WebARKitTrackable *WebARKitTrackerSquare::newTrackable(std::vector<std::string> config)
{
    ...
    if (config.at(0).compare("single") == 0) {
        ...
        ARLOGi("Creating WebARKitTrackableSquare with pattern='%s', width=%f.\n", config.at(1).c_str(), width);
        WebARKitTrackableSquare *ret = new WebARKitTrackableSquare();
        ...
        WebARKitTrackableMultiSquare *ret = new WebARKitTrackableMultiSquare();
        ...
        WebARKitTrackableMultiSquareAuto *ret = new WebARKitTrackableMultiSquareAuto();
...
void WebARKitTrackerSquare::deleteTrackable(WebARKitTrackable **trackable_p)
{
    if (!trackable_p || !(*trackable_p)) return;
    if ((*trackable_p)->type != WebARKitTrackable::SINGLE && (*trackable_p)->type != WebARKitTrackable::MULTI && (*trackable_p)->type != WebARKitTrackable::MULTI_AUTO) return;
...
bool WebARKitTrackerSquare::updateDebugTextureRGBA32(const int videoSourceIndex, uint32_t* buffer)
{
