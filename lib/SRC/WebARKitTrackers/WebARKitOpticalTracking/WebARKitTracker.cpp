...
WebARKitTracker::WebARKitTracker() : corners(4), output(17, 0.0), _valid(false) {}

std::vector<double> WebARKitTracker::getOutputData()
{
    return output;
}

bool WebARKitTracker::isValid()
{
    return _valid;
}
...
void WebARKitTracker::clear_output()
{
