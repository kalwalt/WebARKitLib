...
public:
    ...
    virtual void initialize_gray_raw(uchar* refData, size_t refCols, size_t refRows) = 0;
    virtual void processFrameData(uchar* frameData, size_t frameCols, size_t frameRows, ColorSpace colorSpace) = 0;
