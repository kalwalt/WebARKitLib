...
#ifndef WEBARKITTRACKERSQUARE_H
#define WEBARKITTRACKERSQUARE_H
...
public:
    WebARKitTrackerSquare();
    ~WebARKitTrackerSquare();
    
    WebARKitTrackerType type() const override {
        return WebARKitTrackerType::SQUARE_FIDUCIAL;
    }
