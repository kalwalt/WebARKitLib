/*
 *  WebARKitTrackableMultiSquareAuto.h
 *  artoolkitX
 *
 ...
 */
class WebARKitTrackableMultiSquareAuto : public WebARKitTrackable {
...
private:
    ...
    std::unique_ptr<struct WebARKitTrackableMapPrivateMembers> m_pm;
...
public:
	...
	WebARKitTrackableMultiSquareAuto();
	~WebARKitTrackableMultiSquareAuto();
     ...
     * Then calls WebARKitTrackable::update()
