...
#ifndef WEBARKITTRACKABLEORB2D_H
#define WEBARKITTRACKABLEORB2D_H
 ...
 */
class WebARKitTrackableOrb2d : public WebARKitTrackable {
    
    friend class WebARKitTrackerOrb2d;
...
#endif // !WEBARKITTRACKABLEORB2D_H
