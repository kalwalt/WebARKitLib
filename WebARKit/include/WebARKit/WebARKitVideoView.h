...
#ifndef WEBARKITVIDEOVIEW_H
#define WEBARKITVIDEOVIEW_H
 ...
 */
class ARX_EXTERN WebARKitVideoView {
...
public:
    ...
    WebARKitVideoView();
    bool initWithVideoSource(const WebARKitVideoSource& vs, const int contextWidth, const int contextHeight);
    void getViewport(int32_t viewport[4]) const;
    void draw(WebARKitVideoSource* vs);
