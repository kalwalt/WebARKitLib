...
#ifndef WEBARKITMARKERSQUARE_H
#define WEBARKITMARKERSQUARE_H
...
/**
 * Single marker type of WebARKitTrackable.
 */
class WebARKitTrackableSquare : public WebARKitTrackable {
