...
public:
    ...
    /**
        WebARKitTrackable factory method.
     ...
     */
    virtual WebARKitTrackable *newTrackable(std::vector<std::string> config) = 0;
    virtual void deleteTrackable(WebARKitTrackable **trackable_p) = 0;
