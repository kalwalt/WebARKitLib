...
#ifndef WEBARKITTRACKABLE2D_H
#define WEBARKITTRACKABLE2D_H
 ...
 */
class WebARKitTrackable2d : public WebARKitTrackable {
    
    friend class WebARKitTracker2d;
