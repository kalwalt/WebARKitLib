...
WebARKitTrackableOrb2d::~WebARKitTrackableOrb2d()
{
    if (m_loaded) unload();
}

bool WebARKitTrackableOrb2d::load(const char* dataSetPathname_in)
{
    // Load data.
...
void WebARKitTrackableOrb2d::setTwoDScale(const float scale)
{
    m_twoDScale = scale;
}
